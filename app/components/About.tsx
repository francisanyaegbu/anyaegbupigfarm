...
export const About = () => {
  return (
    <div className='bg-pink-50 p-10'>
        <div className='flex flex-col lg:flex-row items-center gap-5 mt-10 text-white bg-green-800 rounded-2xl p-10 pt-15'>
            <div className='bg-green-100 rounded-full px-5 py-2'>
                <Image src="/about.png" width={80} height={80} alt="About" />
            </div>
            <div>
                <h1 className='text-4xl font-semibold mb-2 text-center lg:text-justify'>About Our Farm</h1>
                <p className='text-lg text-green-200 text-center lg:text-justify'>Kristen Daniels started over 2 
        ...
        <div>
            ...
            <div className='grid lg:grid-cols-2 grid-cols-1 gap-6 mt-8'>
                <div className='bg-white p-6 rounded-xl shadow-md flex flex-col lg:flex-row gap-4'>
