...
export const HomePage = () => {
  return (
     <div className="w-full h-full">
        <div className='flex items-center justify-between gap-20 h-screen p-10 pt-15 bg-green-900'>
            <div className='w-1/2'>
                ...
                <div className='flex items-center gap-4 mt-10'>
                    <button className="bg-white duration-150  text-xl text-green-800 px-4 py-2 rounded-lg font-semibold hover:bg-green-700 hover:text-white flex items-center gap-2 cursor-pointer">
                        <ShoppingCartSimple size={20} />
                        Order Now
                    </button>
                    <button className="ml-2 duration-150 bg-white text-xl text-green-800 px-4 py-2 rounded-lg font-semibold hover:bg-green-700 hover:text-white flex items-center gap-2 cursor-pointer">
                        <ChatCircle size={20} />
                        Chat on WhatsApp
                    </button>
                </div>
            ...
            <div className='bg-green-800 rounded-xl p-8 text-white w-1/2'>
                <div className='grid grid-cols-2 gap-6'>
                    ...
                    <div className='flex flex-col items-center bg-green-700 p-5 rounded-xl'>
                        ...
                        <p className='text-green-100 font-medium'>Satisfied Customers</p>
                    </div>
                    <div className='flex flex-col items-center bg-green-700 p-5 rounded-xl'>
